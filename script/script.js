...
for (let i = 0; i < teamMembers.length; i++) {
    ...
    '<div class="col-9 col-sm-6 col-md-4" id="' + i +'"><div class="card text-center p-0 mx-1 my-3"><img src="./img/' + imgPath + '" alt="' + name +'" class="card-img-top"><div class="card-body"><h5 class="card-title">' + name + '</h5><p class="card-text">' + role + '</p></div></div></div>'
